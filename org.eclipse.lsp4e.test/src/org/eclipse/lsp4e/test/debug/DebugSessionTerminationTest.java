...
public class DebugSessionTerminationTest extends AbstractTestWithProject {
	...
	@Test
	public void testTerminatedWithoutExitedCleansUpWithoutAdapterTerminate() throws Exception {
		ILaunch launch = newLaunch(ILaunchManager.RUN_MODE);
		...
		assertTrue("Debug target should be terminated after adapter-only terminated event", target.isTerminated());
